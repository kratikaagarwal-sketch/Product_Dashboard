...
export default function TrafficEnquiryTab() {
  const labels = M12;
  const visitsData = MN.impr.map(v => v * 0.1);
  const uniqueData = MN.impr.map(v => v * 0.08);
  
  const fenqData = [120, 110, 105, 95, 85, 80, 75, 70, 65, 60, 55, 50];
  const callsData = [450, 440, 460, 455, 470, 480, 475, 490, 500, 510, 520, 530];
